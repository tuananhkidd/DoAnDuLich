                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Danh sách đồ ăn</h5>
                                    <div class="col-sm-12" style="margin: 10px 0px 10px 0px;">
                                        <a href="#addFood" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Thêm Món Ăn</span></a>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                $user = mysqli_query($con,"SELECT * FROM food" ); 
                                                $count = 1;
                                                ...
                                                <td><?php echo $row["food_address"]; ?></td>
                                                <td><?php echo $row["food_detail"]; ?></td>
                                                <td><div class="col-auto"> 
                                                    <a href="#editFood" class="edit" data-toggle="modal">
                                                        <i class="material-icons update_food" data-toggle="tooltip" 
                                                        data-id="<?php echo $row["id"]; ?>"
                                                        data-name="<?php echo $row["food_name"]; ?>"
                                                        data-address="<?php echo $row["food_address"];?>"
                                                        data-detail="<?php echo $row["food_detail"]; ?>"
                                                        title="Edit">&#xE254;</i>
                                                    </a>
                                                <a  href="#deleteFood"class="delete_food" data-id="<?php echo $row["id"]; ?>" data-toggle="modal">
                                    ...
                                    <div class="modal-content">
                                        <form id="user_form">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-success" id="btn-add-food">Add</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-body">
                                                <input type="hidden" id="id_d" name="food_id" class="form-control">                  
                                                <p>Bạn có chắc chắn xóa bản ghi này không?</p>
                                            </div>
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Hủy">
                                                <button type="button" class="btn btn-danger" id="delete_food">Xóa</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
